<h1>2422 - Query Kth Smallest Trimmed Number</h1><h2>Difficulty: Medium - <a href="https://leetcode.com/problems/query-kth-smallest-trimmed-number/">query-kth-smallest-trimmed-number</a></h2><p>You are given a <strong>0-indexed</strong> array of strings <code>nums</code>, where each string is of <strong>equal length</strong> and consists of only digits.</p>
